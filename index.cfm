        ...
        <div class="main-container">
            ...
            <cfloop from="#fromDate#" to="#toDate#" index="i" step=-1>               
                <cfif DateFormat(i,"dddd") eq "Monday">
                        <p class="green"><cfoutput>#DateFormat(i,"dd-mmm-yyyy -dddd")#</cfoutput></p>                                                   
                    <cfelseif DateFormat(i,"dddd") eq "Sunday">
                        <p class="red"><cfoutput>#DateFormat(i,"dd-mmm-yyyy -dddd")#</cfoutput></p>                                                     
                    <cfelseif DateFormat(i,"dddd") eq "Saturday">
                        <p class="red"><cfoutput>#DateFormat(i,"dd-mmm-yyyy -dddd")#</cfoutput></p>
                    <cfelseif DateFormat(i,"dddd") eq "Friday">
                        <p class="blue"><cfoutput>#DateFormat(i,"dd-mmm-yyyy -dddd")#</cfoutput></p>
                    <cfelseif DateFormat(i,"dddd") eq "Thursday">
                        <p class="black"><cfoutput>#DateFormat(i,"dd-mmm-yyyy -dddd")#</cfoutput></p>
                    <cfelseif DateFormat(i,"dddd") eq "Wednesday">
                        <p class="yellow"><cfoutput>#DateFormat(i,"dd-mmm-yyyy -dddd")#</cfoutput></p>
                    <cfelseif DateFormat(i,"dddd") eq "Tuesday">
                        <p class="orange"><cfoutput>#DateFormat(i,"dd-mmm-yyyy -dddd")#</cfoutput></p>                                                                       
                </cfif>
            </cfloop>
        </div>
    </body>
